...
\subsection{Exploration Floor (\texorpdfstring{$\varepsilon$}{epsilon})}
...
\subsection{Empirical Signal of Optimization Convergence}
...
\toprule
Benchmark & Type & Architecture & Tasks & Samples \\
\midrule
Split-MNIST & Class-incr. & MLP (256h) & 2 & 5k/task \\
Permuted-MNIST & Domain-incr. & MLP (256h) & 2 & 5k/task \\
Rotated-MNIST & Gradual shift & MLP (256h) & 5 & 2k/task \\
Split-Fashion & Class-incr. & MLP (256h) & 2 & 5k/task \\
Split-CIFAR10 & Class-incr. & CNN (32-64, 256fc) & 2 & 2.5k/task \\
Split-CIFAR100 & Class-incr. & CNN (32-64, 256fc) & 2 & 2k/task \\
\bottomrule
\end{tabular}
\end{table}
